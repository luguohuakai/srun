...
class FinancialV2 extends SrunV2
{
     ...
     */
    public function rechargeWallet($user_name, int $pay_type_id = 1, array $other = [])
    {
        $data = [
            'user_name' => $user_name,
        ...
        return $this->req('api/v2/financial/recharge-wallet', $data, 'post');
    }
    ...
    public function paymentRecord($user_name, $page = null, $size = null, $order_no = null, $start_at = null, $stop_at = null, $pay_type_id = null)
    {
        ...
        return $this->req('api/v2/financial/payment-records', $data);
    }
    ...
    public function refund($user_name, $refund_num = null, $product_id = null, $mgr_name = null, $start_at = null, $stop_at = null)
    {
        ...
        if ($start_at !== null) $data['start_at'] = $start_at;
        if ($stop_at !== null) $data['stop_at'] = $stop_at;
        return $this->req('api/v2/financial/refund', $data);
    }
    ...
    public function checkoutListDetail($user_name, $start_at = null, $stop_at = null)
    {
        ...
        if ($start_at !== null) $data['start_at'] = $start_at;
        if ($stop_at !== null) $data['stop_at'] = $stop_at;
        return $this->req('api/v2/checkoutlist/detail', $data);
    }
    ...
    {
        return $this->req('api/v2/financial/transfer', compact('user_name', 'amount', 'transfer_account'), 'post');
    }
    ...
    {
        return $this->req('api/v2/financial/recharge-cards', compact('ka_card_num', 'ka_passwd'));
    }
    ...
    {
        return $this->req('api/v2/financial/extra-pay', array_merge(compact('extra_pay_id'), $other), 'post');
    }
    ...
    public function paymentDataSync($user_name, $trade_no, $money, $buy_time, $pay_type, $remark = null)
    {
        ...
        return $this->req('api/v2/financial/payment-data-sync', $data, 'post');
    }
    ...
    public function paymentOverview($pay_type_id, $start_time = null, $stop_time = null)
    {
        ...
        return $this->req('api/v2/financial/payment-overview', $data);
    }
    ...
    {
        return $this->req('api/v2/financial/pay-type');
    }
    ...
    public function createPayment($type_name, $default = null, $is_balance = null)
    {
        ...
        return $this->req('api/v2/financial/create-payment', $data, 'post');
    }
    ...
    public function updatePayment($pay_type_id, $type_name = null, $default = null, $is_balance = null)
    {
        ...
        if ($default !== null) $data['default'] = $default;
        if ($is_balance !== null) $data['is_balance'] = $is_balance;
        return $this->req('api/v2/financial/update-payment', $data, 'post');
    }
    ...
    {
        return $this->req('api/v2/financial/delete-payment', compact('pay_type_id'), 'delete');
    }
    ...
    public function packageRechargeRecord($user_name, $start_at = null, $stop_at = null)
    {
        ...
        if ($start_at !== null) $data['start_at'] = $start_at;
        if ($stop_at !== null) $data['stop_at'] = $stop_at;
        return $this->req('api/v2/financial/package-recharge-record', $data);
    }
}